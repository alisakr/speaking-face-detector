...
def get_times_and_speakers(json_filename=None, transcript_json=None, speakers_to_include=None, start_time_seconds=0, end_time_seconds=None, image_for_each_segment=True):
    '''
